...
TEST(BookSystemTest, Constructor) {
    BookSystem testBookSystem("../tests/test_files/test_catalogue.json", "../tests/test_files/test_checked_out.json");
...
TEST(BookSystemTest, CheckExpirationExpired) {
    BookSystem testBookSystem("../tests/test_files/test_catalogue.json", "../tests/test_files/test_checked_out.json", 1);
    User* me = new User("Daniel", 100, nullptr, 2132321);
    testBookSystem.CheckOut(me, 9781506713816);
...
TEST(BookSystemTest, SaveCatalogue) {
    BookSystem testBookSystem("../tests/test_files/test_catalogue.json", "../tests/test_files/test_checked_out.json");
    testBookSystem.SaveCatalogue("../tests/test_files/output.json");
    
    BookSystem testBookSystem2("../tests/test_files/output.json", "../tests/test_files/test_checked_out.json");
...
TEST(BookSystemTest, SaveCatalogueAddedBooks) {
    ...
    BookSystem testBookSystem2("../tests/test_files/output.json", "test_files/test_checked_out.json");
...
TEST(BookSystemTest, SaveCheckedOut) {
    ...
    User* me = new User("Daniel", 100, nullptr, 2132321);
    testBookSystem.CheckOut(me, 9781506713816);
    testBookSystem.SaveCheckedOut("../tests/test_files/output.json");
    EXPECT_TRUE(true);
    nlohmann::json jsonParcer;
    ifstream inFS("../tests/test_files/output.json");
    inFS >> jsonParcer;
